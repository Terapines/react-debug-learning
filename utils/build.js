...
function getRollupOutputOptions(
    ...
    return {
        ...
        name: globalName,
        sourcemap: true,
        sourcemapPathTransform: function(relativeSourcePath, sourcemapPath){
            // will replace relative paths with absolute paths
            // the below path need to change according to host
            if(process.platform == "win32") {
                return relativeSourcePath.replace("..\\..\\..\\..\\packages", "D:\\training\\react\\packages")
            }
            return relativeSourcePath.replace("../../../../packages", "D:\\training\\react\\packages")
          },
        esModule:false
